...
import { makeFrame,compressFrame,drawFrame,vp } from "./core/renderer/renderer.js"
...
//options, collider collision trigger, children
    constructor(x,y,z,opts){
     ...
     this.arr=this.getText(this.txt)
     this.setText=t=>this.getText(t)
    ...
    async getPixels(){
        ...
        return [...Array(this.tile.x)].reduce((a,rw)=>a.concat(r),[])
    	})} 
    	if(this.tile.y){
        this.pixels=[...Array(this.tile.y)].reduce((a,rw)=>a.concat(this.pixels),[])
    }
...
const renderer={makeFrame,compressFrame,drawFrame}
